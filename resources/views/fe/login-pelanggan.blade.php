...
<body>
    <div class="half">
        <div class="bg" style="background-image: url('fe/img/bg2.jpg')"></div>
        <div class="contents">
            <div class="container">
                    ...
                    <div class="col-md-12">
                        <div class="form-block mx-auto">
                            <div class="text-center mb-3">
                                <h4 class="bold fw-bold">Hi, Selamat Datang!</h4>
                            ...
                            <form action="{{ route('authenticate') }}" method="post">
                                ...
                                <div class="d-sm-flex mb-5 align-items-center">
                                    <label class="control control--checkbox d-flex align-items-center mb-3 mb-sm-0">
                                        ...
                                        <span class="mb-0">Ingat Password</span>
                                    </label>
                                    <span class="ms-auto"><a href="#" class="forgot-pass small">Lupa Kata Sandi</a></span>
                                </div>
                                <input type="submit" value="Masuk" class="btn btn-block py-2 btn-primary1">
                                <div class="d-flex justify-content-center mt-3"> 
                                    <label>Belum Punya Akun? <a href="register" class="fw-bold">Daftar</a></label>
                                </div>
