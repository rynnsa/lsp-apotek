                                ...
                                @foreach ($jenis_pengirimans as $jenis_pengiriman)
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            ...
                                            <form action="{{ route('jenispengiriman.destroy', $jenis_pengiriman->id) }}" method="POST" class="d-inline delete-form" data-item-name="{{ $jenis_pengiriman->jenis_pengiriman }}">
                                                @csrf
                                                @method('DELETE')
        ...
        deleteForms.forEach(form => {
            form.addEventListener('submit', function(e) {
                ...
                Swal.fire({
                    ...
                    html: `<span class="text-dark">Apakah Anda yakin ingin menghapus jenis pengiriman <strong>${itemName}</strong>?</span>`,
                    icon: 'warning',
